...
public class GlobalExceptionHandler {
    ...
    // 1. Concurrency Hatası (Optimistic Locking)
    ...
    // 2. Domain Kuralları İhlali (Yetersiz bakiye vb.)
    ...
    // 4. Validasyon Hataları (DTO üzerindeki @NotNull vb.)
    ...
    public ResponseEntity<ApiErrorResponse> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        // Hata mesajı genellikle DB driver'dan gelir ve constraint adını içerir.
        // Postgres'te genellikle "transaction_reference" kolon adı mesajda geçer.
        ...
        if (rootMsg != null && rootMsg.contains("transaction_reference")) {
            ...
            // İstemciye 200 OK dönüyoruz, böylece retry yapmayı bırakıyor.
            return ResponseEntity
                    .status(HttpStatus.OK)
                    .body(ApiErrorResponse.of("IDEMPOTENCY_HANDLED", "Transaction already processed successfully (Idempotent)."));
        }

        // Eğer başka bir constraint (örn: account_number unique) patladıysa bu gerçek bir hatadır.
